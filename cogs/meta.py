...
class Meta(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        em.add_field(name='Source code', value='Hugmaker is open source under the MIT license! You can find the code \
            at <https://github.com/amazansky/hugmaker>. In addition, any images generated by hugmaker are available \
            under CC BY 4.0. Have any issues or run into problems using the bot? Report them at the issue tracker: \
